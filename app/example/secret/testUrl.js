    ...
    return new Promise(function (resolve, reject) {
        ...
        let getcheckwordInner = function () {
            ...
            if (neadReload == false) {
                ...
                downloadImg('http://zxgk.court.gov.cn/zhzxgk/captcha.do?captchaId=bd2fd457ede44d26a018d71a2abf9fc7&random=0.7330692537629279', savePath).then(() => {
                    neadReload = false;
                    getcheckwordInner();
                })
            }
